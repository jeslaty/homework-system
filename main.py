...
st.markdown("""
    ...
    *, .stApp, p, span, label, div, h1, h2, h3, input, button, textarea {
    ...
    /* 🚀【全格點擊智慧功能磚魔改】將跳轉連結本身改造成高級曜石深黑色大卡片，整塊大區域皆可直接一鍵點擊跳轉！ */
    .stPageLink a {
    ...
    /* 🚀 當滑鼠滑入大格子時，外框會亮起清爽亮藍色並微幅浮起 */
    .stPageLink a:hover {
        border: 2.5px solid #38BDF8 !important; transform: translateY(-4px) !important;
    }
    /* 🚀 讓卡片內部的「聯絡簿管理」與「作業登錄系統」字體巨大化、高對比發光純白呈現 */
    .stPageLink a p {
...
# 🎯【100% 正確指定欄位索引】整塊大格子就是最乾淨、最直覺的跨頁傳送門！
with dash_grid[0]:
