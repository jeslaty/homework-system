...
# 🎨 注入【Apple 級極簡 3D 智慧功能磚 - 登入按鈕字體 100% 物理強制純黑對焦版】
st.markdown("""
    <style>
    /* 🍏 全局強制使用現代無襯線字體 */
    *, .stApp, p, span, label, div, h1, h2, h3, input, button, textarea {
    ...
    /* 🎯【終極精準校正：強迫登入按鈕內部的『確認登入』文字一律鎖定為特粗純黑色，拒絕隱形字！】 */
    ...
    .stPageLink a {
        ...
        box-shadow: 0 12px 30px rgba(0, 0, 0, 0.6) !important; text-decoration: none !important;
