...
# 1. 頁面基本設定
st.set_page_config(page_title="801每日聯絡簿管理", page_icon="📝", layout="wide")
    ...
    for i in range(0, len(STUDENT_NAMES), 4):
        ...
        for idx_grid in range(4):
            ...
            if student_idx < len(STUDENT_NAMES):
                ...
                gender_icon = "🌸" if seat_num <= 14 else "🍀"  # 依實際男女生座號進行分界調整
